...
| **Applicazione per i venditori** («Mondo Tracking») | **Finita**, portali compresi (4 settembre). La pagina `/tracking/[token]`, il riquadro sulla scheda immobile per creare e mandare il link, e il *registro di garanzia* con i collegamenti agli annunci. **I passi 1-5 sono in esercizio; i portali (passo 6) non sono ancora sul server.** Vedi «I due progetti nuovi», qui sotto. |
...
vanno verificati i suoi numeri, che al capitolo 5 non tornavano: *1.221 visite*
su un annuncio con **0 giorni di pubblicazione**. Mandare al proprietario un
numero che significa un'altra cosa e' una figura sua.
...
> `CONSEGNA.md`) e che l'ultima cosa costruita sono i **messaggi di errore che
> si leggono** (punto 20): i rifiuti tornano dalle azioni come testo e compaiono
> sopra il pulsante Salva senza far perdere quello che si era scritto, e sotto
> c'e' la rete di `error.tsx` e `not-found.tsx`. E' committato e pushato,
> **ma non e' ancora sul server**.
>
> So che sono aperti **due progetti nuovi**, nati il 4 settembre e senza una
> riga di codice ancora scritta — «I due progetti nuovi» nel capitolo 5:
> l'**applicazione per i venditori** (che sta in una finestra sua: qui si fa la
> parte del gestionale) e soprattutto la **pubblicazione sui portali**, il piu'
> urgente, dopo che ha dismesso Casagest24 e ha cominciato a pubblicare a mano.
>
> Resta aperto, e aspetta lui: le risposte dei portali sullo stacco di
> Casagest24 e sul flusso XML; l'**SMTP**, fermo sulla sola password per le app
> di Gmail; i **dati dei venditori**; gli **indirizzi degli immobili vecchi**;
> le **zone in `ZONE_PER_COMUNE`** da far correggere a lui, che il mercato lo
> conosce.
>
