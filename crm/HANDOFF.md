...
>
> So che i **passi 1-5 sono gia' sul server** e il **passo 6 (i portali) no**:
> va lanciato `aggiorna.sh`. E' la prima pagina di questo programma
> raggiungibile senza accesso, quindi ogni lettura nuova che la riguarda va
> agganciata all'immobile della chiave, mai a un utente.
>
