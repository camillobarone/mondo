...
> `CONSEGNA.md`). L'ultima cosa fatta e' una **correzione agli incroci**: negli
> «immobili da valutare» arrivavano comuni diversi da quelli chiesti, perche'
> «Lecce» sta dentro «Monteroni di Lecce» e il confronto si fermava li'. Prima
> ancora, gli **avvisi sul telefono**:
